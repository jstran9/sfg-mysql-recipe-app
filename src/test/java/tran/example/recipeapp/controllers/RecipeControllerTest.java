...
public class RecipeControllerTest {
    ...
    public void setUp() throws Exception {
        ...
        // since we are wiring in the controller advice ourselves these tests will remain lightweight.
    ...
    public void saveOrUpdate() throws Exception {
        ...
        mockMvc.perform(post("/recipe")
                ...
                .param("directions", "example directions!"))
                .andExpect(status().is3xxRedirection())
                .andExpect(view().name("redirect:/recipe/2/show"));
    }

    @Test
    public void saveOrUpdateValidationWillFail() throws Exception {
    ...
    @Test
    public void saveOrUpdateCookTimeValidation() throws Exception {
        RecipeCommand command = new RecipeCommand();
        command.setId(2L);
